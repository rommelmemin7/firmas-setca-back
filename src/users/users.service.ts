...
export class UsersService {
	...
	async register(name: string, email: string, password: string, roleId: number) {
		try {
	...
	async findAll() {
		...
		return Utils.formatResponseSuccess('Usuarios obtenidos exitosamente', users);
	}
	...
	async update(id: number, data: UpdateUserDto) {
		try {
			...
			return Utils.formatResponseSuccess('Usuario actualizado exitosamente', userUpdate);
		} catch (e) {
			return Utils.formatResponseFail('Error al actualizar el usuario ' + e.message);
		}
	}
}
